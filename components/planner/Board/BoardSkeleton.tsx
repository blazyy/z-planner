...
const TaskCardSkeleton = () => (
  <div className='flex flex-col gap-2 bg-white shadow-sm mb-2 p-3 rounded-lg'>
...
const ColumnSkeleton = ({ cardCount }: { cardCount: number }) => (
  <div className='flex flex-col gap-1 mr-2 w-96'>
    <div className='bg-white shadow-sm mb-1 p-2 rounded-lg'>
    ...
    <div
      className='flex flex-col bg-neutral-100 p-1 px-2 rounded-lg grow'
