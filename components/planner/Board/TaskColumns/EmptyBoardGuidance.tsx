...
export const EmptyBoardGuidance = () => {
  return (
    <div
      className='flex flex-col flex-1 justify-center items-center gap-3 px-4 text-center text-neutral-400 select-none'
      role='note'
    >
      <Columns className='w-10 h-10' aria-hidden='true' />
      <p className='font-medium text-neutral-600 text-lg'>This board has no columns yet</p>
